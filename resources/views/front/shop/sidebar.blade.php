<div class="col-md-3 mb-md">
    <a href="{{ url( 'donate' ) }}" class="btn default btn-block blue mb-md"> {{ trans( 'main.acc_balance', ['money' => number_format( Auth::user()->money, 2 ), 'currency' => settings('currency_name')] ) }} </a>
