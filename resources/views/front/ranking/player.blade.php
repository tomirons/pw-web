            ...
            <div class="table-responsive">
                <table class="table">
                    ...
                    <tr>
                        ...
                        <th> {{ trans( 'ranking.gender.caption' ) }}</th>
                        <th> {{ trans( 'ranking.spouse.caption' ) }}</th>
                    ...
                    @foreach( $ranks as $rank )
                        <tr>
                            ...
                            <td>
                                <img src="/img/gender/{{ $rank->gender }}.png"> {{ trans('ranking.gender.' . $rank->gender ) }}
                            </td>
                            <td>
                                @if( $rank->spouse )
                                    @if( !$players->getSpouse($rank->spouse) )
                                        {{ trans('ranking.spouse.4everalone') }}
                                    @else
